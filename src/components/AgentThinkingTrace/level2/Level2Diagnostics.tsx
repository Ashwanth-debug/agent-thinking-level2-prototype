...
const SOURCE_LABEL: Record<string, string> = {
  phoenix: 'Recorded trace — mapped live',
  cached_phoenix: 'Recorded trace — cached',
  fixture: 'Demo fixture — hand-authored',
};
    ...
    <div className="att-dev-inspector">
      ...
      <div className="att-dev-playback">
        ...
        <button
          ...
          title={runtime.actualTimingAvailable ? 'Replay this scenario on the recorded trace clock' : 'Real timing unavailable for this scenario'}
      ...
      <div className="att-dev-body">
        {tab === 'scenario' && (
          <div className="att-dev-meta-grid">
            ...
            <Row label="Data source" value="Demo fixtures (bundled, sanitized)" />
