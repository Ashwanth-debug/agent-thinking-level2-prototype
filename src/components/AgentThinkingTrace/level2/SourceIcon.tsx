...
/* ─────────────────────────────────────────────────────────────────────────────
   ...
   favicon comes from Google's public s2 favicon service (unauthenticated,
   no key involved) so it works on any deployment origin.

   Failure is expected and handled, not exceptional: plenty of domains have no
   favicon, and the service can be unreachable entirely. Either way this falls
